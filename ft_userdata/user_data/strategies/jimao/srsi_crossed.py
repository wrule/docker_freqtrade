...
class SRSICrossed(IStrategy):
    ...
    buy_length = IntParameter(49, 49 + 1, default = 49)
    buy_rsi_length = IntParameter(8, 8 + 1, default = 8)
    buy_k = IntParameter(8, 8 + 1, default = 8)
    buy_d = IntParameter(27, 27 + 1, default = 27)
