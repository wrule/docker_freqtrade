...
class SRSICrossed(IStrategy):
    ...
    buy_length = IntParameter(49 - 3, 49 + 3, default = 49)
    buy_rsi_length = IntParameter(8 - 3, 8 + 3, default = 8)
    buy_k = IntParameter(8 - 3, 8 + 3, default = 8)
    buy_d = IntParameter(27 - 3, 27 + 3, default = 27)
